...
function SignupPage() {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-background">
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-[#0D0D0D] via-black to-[#1A1A1A] p-12 text-white">
      ...
      {/* Right Login Section */}
      <div className="flex items-center justify-center p-8 bg-background relative z-10 w-full">
        <div className="w-full max-w-[420px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {error && (
              <div className="p-3 text-sm text-red-500 bg-red-100 dark:bg-red-950/20 border border-red-200 dark:border-red-900/30 rounded-lg">
                {error}
              </div>
            )}
